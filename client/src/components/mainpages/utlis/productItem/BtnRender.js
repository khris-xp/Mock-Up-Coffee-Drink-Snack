        ...
        <div className="w-full my-[10px] flex justify-between">
            {
                isAdmin ?
                    ...
                    : <>
                        <Link to="/" onClick={() => addCart(product)} className="w-[50%] text-center uppercase text-white tracking-[2px] mr-[5px] inline-block px-6 py-2.5 bg-green-600 font-medium text-sm leading-tight rounded-full shadow-md hover:bg-green-700 hover:shadow-lg focus:bg-green-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-green-800 active:shadow-lg transition duration-150 ease-in-out">
                            Buy
                        </Link>
